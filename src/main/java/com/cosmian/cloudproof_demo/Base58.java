...
/*
 * Copyright 2011 Google Inc. Copyright 2018 Andreas Schildbach From
 * https://github.com/bitcoinj/bitcoinj/blob/master/core/src/main/java/org/bitcoinj/core/Base58.java Licensed under the
...
public class Base58 {
    ...
    public static byte[] decode(String input) {
        ...
        for (int i = 0; i < input.length(); ++i) {
            ...
            if (digit < 0) {
                throw new IllegalStateException("InvalidCharacter in base 58 at position " + i + " of string " + input);
            }
